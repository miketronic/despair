...
#define HMSE    LT(_MSE, KC_H)          // Tap for "H", hold for Mouse layer
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ALPHA] = LAYOUT (
   ...
   KC_A,  KC_S,  KC_D,  KC_F,  KC_G,  HMSE,  KC_J,  KC_K,  KC_L,   KC_SCLN,
  ...
  [_MSE] = LAYOUT (
    XXXX, XXXX,    KC_WH_U,  KC_MS_U,  KC_WH_D,    KC_MINS,KC_UNDS, XXXX, XXXX,   XXXX,
    XXXX, XXXX,    KC_MS_L,  KC_MS_D,  KC_MS_R,    XXXX,     XXXX, XXXX, XXXX,    XXXX,
    XXXX, XXXX,    KC_BTN3,  KC_BTN2,  KC_BTN1,    XXXX,     XXXX, XXXX, XXXX,    XXXX,
    SFTSPC, SFTSPC,  KC_BTN1,  KC_BTN3,  KC_BTN3, KC_BTN1, SFTENT,  SFTENT
   ),
